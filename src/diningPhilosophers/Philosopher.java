 ...
 * A philosopher has three states: THINKING, HUNGRY, and EATING. 
 * Each state has a random amount of wait time. A philosopher can
 * only move to EATING state if they pick up forks from both their
 * left and right side.
 */
